...
class ImageNet(ImageFolder):
    ...
    def __init__(self, root, split='train', download=None, **kwargs):
        ...
        self.split = verify_str_arg(split, "split", ("TrainingSet", "ValidationSet"))
...
if __name__ == '__main__':
    ...
    imagenet = ImageNet(root = "/datasets/ImageNet/ILSVRC2012", split="TrainingSet", transform=input_transform, target_transform=None, download=False)
    imagenet_val = ImageNet(root="/datasets/ImageNet/ILSVRC2012", split="ValidationSet", transform=input_transform,
