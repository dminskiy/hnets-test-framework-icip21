...
class ScatteringBase1D(ScatteringBase):
    ...
    r"""The 1D scattering transform
        ...
        While the wavelets are fixed, other_readers parameters may be changed after
        ...
        ----------
        J : int
            The maximum log-scale of the scattering transform. In other_readers words,
    ...
    """Apply the scattering transform
       ...
       while other_readers keys contain additional information, such as `'j'` (the
